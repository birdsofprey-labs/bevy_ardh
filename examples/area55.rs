...
use ardh::skirt_grid::GridWithSkirts;

const PLANET_SIZE: f32 = 1000.0;//999.9;
fn main() {
    App::new()
...
fn setup_system(
    ...
    let pmesh = Mesh::from(GridWithSkirts { size: PLANET_SIZE*4.0, subdivisions: 128, length: 0.0, offscale: 1.02 })
